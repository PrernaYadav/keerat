...
//                        Intent intent = new Intent(OtpConfirmationActivity.this, OtpConfirmationActivity.class);
                      ...
                      }else if (ser.equals("Gurudwara")){
                          Intent i = new Intent(OtpConfirmationActivity.this, RegisterServiceGurudwaraSahib.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ConfigInfo.resend,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                      ...
                      /*  Intent intent = new Intent(OtpConfirmationActivity.this, Registerserviceoptionsenabled.class);
                        intent.putExtra("data", response.toString());
